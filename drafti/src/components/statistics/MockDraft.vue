<template>
  <div class="center container mock">
    <form @submit.prevent="createMock" class="card-panel hoverable">
      ...
      <div class="row">
        <div class="col m6 l6 offset-m3 offset-l3 field">
